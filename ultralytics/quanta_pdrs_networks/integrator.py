...
class PoissonDualRateSplit(nn.Module):
    ...
    def _integrate_chunk_parallel(self, photon_cube: Tensor) -> Tensor:
        ...
        p_motion = torch.sigmoid(self.motion_sharpness * (score_smooth - self.motion_threshold))
        del score_smooth
    ...
    def _integrate_streaming(self, photon_cube: Tensor) -> Tensor:
        ...
        for ti in range(t):
            ...
            p_motion[..., ti] = torch.sigmoid(self.motion_sharpness * (score_sm - self.motion_threshold))
