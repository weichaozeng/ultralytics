...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="/home/zvc/Project/FPHA/Tracking_Results/PoseTrack_0.4_iou_0.45")
    parser.add_argument("--det_thresh", type=float, default=0.4)
    parser.add_argument("--ckpt", type=str, default="weights/detector.pt")
    parser.add_argument("--tracker", type=str, default="posetrack", choices=["posetrack", "bytetrack", "botsort"])
