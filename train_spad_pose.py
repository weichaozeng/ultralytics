    ...
    cfg.update(
        {
            ...
            "plugin": args.plugin,
            "plugin_scales": args.plugin_scales,
            "temporal_core": args.temporal_core,
            "ssd_state_dim": args.ssd_state_dim,
            "ssd_head_divisor": args.ssd_head_divisor,
            "spatial_reduce_ratio": args.spatial_reduce_ratio,
            "spatial_kernel_size": args.spatial_kernel_size,
            "plugin_alpha_init": args.plugin_alpha_init,
